...
comment on function public.resolve_resume_intake(uuid, uuid, text, uuid, text) is
  'Resolves a resume intake. Linking to an existing person requires the reviewed source name and explicit human choice; creating a person still requires name plus email or phone.';
