...
begin
  ...
  from pg_proc function_entry join pg_namespace namespace_entry on namespace_entry.oid = function_entry.pronamespace
  where namespace_entry.nspname = 'public' and function_entry.proname = 'resolve_occupation_on_demand'
  ...
  definition := replace(definition,
    ...
    '(select concept.canonical_label from public.knowledge_concepts concept where concept.id = v_existing.canonical_occupation_concept_id)');
  execute definition;
end;
$$;
