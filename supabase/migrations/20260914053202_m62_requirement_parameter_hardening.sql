-- M6.2 hardening: persisted Position semantics override client-supplied parameters.
...
comment on function public.create_m62_verification_need is 'M6.2: creates or reuses an exact need and rejects level or criticality drift from the immutable Position version.';
