-- Keep the partial-resume recovery behavior introduced after adaptive extraction,
-- while restoring the geometry and field-evidence contract consumed by M5.

drop function private.persist_person_extraction(
