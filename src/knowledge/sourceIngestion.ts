...
function classifyEscoConcept(rawType: string, uri: string): KnowledgeConceptType { const normalized = rawType.toLowerCase(); if (normalized.includes("occupation") || uri.includes("/occupation/")) return "occupation"; if (normalized.includes("knowledge")) return "knowledge"; if (normalized.includes("competence")) return "competency"; return "skill"; }
