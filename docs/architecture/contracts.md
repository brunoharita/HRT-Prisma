...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `professional-profile` | AI/domain | 5.1.0 | review, retrieval, matching, repository | compatibilidade de publicação ativa em QA | perfil versionado, PII excluída, omissões preservadas e fatos históricos normalizados sem inferência | local/QA | bloquear |
...
| `profile-publication-delta` | product/application/data | 1.1.0 | revisão, publicação, Central da Pessoa | compatibilidade histórica ativa em QA; preflight web local | omissões preservadas, legado aprovado normalizado e remoções explícitas auditadas | local/QA | bloquear publicação com campo acionável |
