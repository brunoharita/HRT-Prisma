...
| `human-profile-review` | application/domain | 7.1.0 | revisão, Delta, perfil, auditoria | RPCs v3 e auditoria factual automática ativas em QA | edição comum registra ator, data, antes/depois, evidência e versão; remoção aprovada continua exigindo motivo | local/QA | bloquear promoção inválida |
