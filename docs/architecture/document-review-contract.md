...
| `human-profile-review` | 7.1.0 | revisão aceita extração parcial, registra correções comuns sem texto livre obrigatório, exige confirmação acadêmica revisável e termina em Delta antes da publicação atômica |
