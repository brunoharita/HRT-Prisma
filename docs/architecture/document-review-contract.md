...
| `document-presentation` | 1.1.0 | perfil vigente, documento, tentativa e revisão são compostos sem condensar estado na Pessoa; consulta curricular reutiliza o workspace M5 sem permitir mutações |
