...
| OCR | scan legível com fallback seletivo e assets locais | página insuficiente após OCR, worker/core/idioma indisponível | Tesseract local comprovado em uma página; worker, core WASM e dados `por+eng` entram no bundle web; fixture inicial insuficiente foi recusada e fixture válida gerou 360 caracteres úteis |
