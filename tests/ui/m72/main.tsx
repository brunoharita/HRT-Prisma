...
const concepts: Array<[string, string, ProfessionalConceptType, "declared" | "contextual" | "demonstrated"]> = [
  ...
  ["leadership", "Liderança técnica", "occupation", "contextual"], ["team", "Trabalho em equipe", "skill", "demonstrated"],
